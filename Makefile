...
deps:
	sudo apt update && apt install -y build-essential curl libssl-dev zlib1g-dev libbz2-dev libreadline-dev libsqlite3-dev liblzma-dev tk-dev
...
# ===== RUN APP =====
run:
	. $(VENV)/bin/activate && python3.9 esp32_modbus.py
